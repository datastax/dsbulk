...
import static com.datastax.oss.dsbulk.format.row.RowFormatterSymbols.summaryEnd;
import static com.datastax.oss.dsbulk.format.row.RowFormatterSymbols.summaryStart;
import static com.datastax.oss.dsbulk.format.row.RowFormatterSymbols.valuesCount;
