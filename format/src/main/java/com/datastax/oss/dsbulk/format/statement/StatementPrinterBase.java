...
import static com.datastax.oss.dsbulk.format.statement.StatementFormatVerbosity.NORMAL;
import static com.datastax.oss.dsbulk.format.statement.StatementFormatterSymbols.consistencyLevel;
import static com.datastax.oss.dsbulk.format.statement.StatementFormatterSymbols.idempotent;
import static com.datastax.oss.dsbulk.format.statement.StatementFormatterSymbols.listElementSeparator;
import static com.datastax.oss.dsbulk.format.statement.StatementFormatterSymbols.serialConsistencyLevel;
...
import static com.datastax.oss.dsbulk.format.statement.StatementFormatterSymbols.timeout;
import static com.datastax.oss.dsbulk.format.statement.StatementFormatterSymbols.timestamp;
import static com.datastax.oss.dsbulk.format.statement.StatementFormatterSymbols.unsetValue;
