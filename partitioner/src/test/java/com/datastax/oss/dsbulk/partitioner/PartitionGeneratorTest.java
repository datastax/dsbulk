...
class PartitionGeneratorTest {
  ...
  private final Set<com.datastax.oss.driver.api.core.metadata.token.TokenRange> singleDCRanges =
  ...
  private final Set<com.datastax.oss.driver.api.core.metadata.token.TokenRange> multiDCRanges =
  ...
  void should_split_single_dc() {
    ...
    Assertions.assertThat(splits.size()).isEqualTo(9);
    ...
    assertThat(splits.get(0))
        ...
        .hasReplicas(host1)
        .hasFraction(0.1111111111111111d, Assertions.offset(.000000001d));
    ...
    Assertions.assertThat(splits.stream().map(TokenRange::fraction).reduce(0d, Double::sum))
        .isEqualTo(1d, Assertions.offset(.000000001));
  }
  ...
  void should_split_multi_dc() {
    ...
    Assertions.assertThat(splits.size()).isEqualTo(12);
    ...
    assertThat(splits.get(0))
        ...
        .hasFraction(5.421010862427522E-18d, Assertions.offset(.000000001d));
    assertThat(splits.get(4))
        .startsWith(-3074457345618258603L)
