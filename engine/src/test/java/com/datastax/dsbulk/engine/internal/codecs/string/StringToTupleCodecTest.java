...
public class StringToTupleCodecTest {
  ...
  public void setUp() throws Exception {
    ...
    ConvertingCodec eltCodec1 = new JsonNodeToInstantCodec(CQL_DATE_TIME_FORMAT);
    ConvertingCodec eltCodec2 = new JsonNodeToStringCodec(TypeCodec.varchar());
    @SuppressWarnings("unchecked")
    List<ConvertingCodec<JsonNode, Object>> eltCodecs = Lists.newArrayList(eltCodec1, eltCodec2);
    codec =
