...
class DCInferringDseLoadBalancingPolicyQueryPlanTest
  ...
  @Test
  void should_use_round_robin_when_no_request() {
    // Given
    request = null;
    // When
  ...
  @Test
  void should_use_round_robin_when_no_session() {
    // Given
    session = null;
    // When
    List<Queue<Node>> plans = generateQueryPlans();
  ...
  @Test
  void should_use_round_robin_when_request_has_no_routing_keyspace() {
    // Given
  ...
  @Test
  void should_use_round_robin_when_request_has_no_routing_key_or_token() {
    // Given
    given(request.getKeyspace()).willReturn(null);
  ...
  @Test
  void should_use_round_robin_when_token_map_absent() {
    // Given
    given(request.getKeyspace()).willReturn(null);
    given(request.getRoutingKeyspace()).willReturn(KEYSPACE);
  ...
  @Test
  void should_prioritize_single_replica() {
    // Given
    given(request.getRoutingKeyspace()).willReturn(KEYSPACE);
    given(request.getRoutingKey()).willReturn(ROUTING_KEY);
  ...
  @Test
  void should_prioritize_and_shuffle_2_replicas() {
    // Given
    given(request.getRoutingKeyspace()).willReturn(KEYSPACE);
    given(request.getRoutingKey()).willReturn(ROUTING_KEY);
  ...
  @Test
  void should_prioritize_and_shuffle_3_or_more_replicas_when_all_healthy_and_all_newly_up() {
    // Given
    given(request.getRoutingKeyspace()).willReturn(KEYSPACE);
    given(request.getRoutingKey()).willReturn(ROUTING_KEY);
  ...
  @Test
  void should_prioritize_and_shuffle_3_or_more_replicas_when_first_unhealthy() {
    // Given
    given(request.getRoutingKeyspace()).willReturn(KEYSPACE);
    given(request.getRoutingKey()).willReturn(ROUTING_KEY);
    given(tokenMap.getReplicas(KEYSPACE, ROUTING_KEY))
  ...
  @Test
  void should_not_treat_node_as_unhealthy_if_has_in_flight_exceeded_but_response_times_normal() {
    // Given
    given(request.getRoutingKeyspace()).willReturn(KEYSPACE);
    given(request.getRoutingKey()).willReturn(ROUTING_KEY);
    given(tokenMap.getReplicas(KEYSPACE, ROUTING_KEY))
  ...
  @Test
  void should_prioritize_and_shuffle_3_or_more_replicas_when_last_unhealthy() {
    // Given
    given(request.getRoutingKeyspace()).willReturn(KEYSPACE);
    given(request.getRoutingKey()).willReturn(ROUTING_KEY);
    given(tokenMap.getReplicas(KEYSPACE, ROUTING_KEY))
  ...
  @Test
  void should_prioritize_and_shuffle_3_or_more_replicas_when_majority_unhealthy() {
    // Given
    given(request.getRoutingKeyspace()).willReturn(KEYSPACE);
    given(request.getRoutingKey()).willReturn(ROUTING_KEY);
    given(tokenMap.getReplicas(KEYSPACE, ROUTING_KEY))
  ...
  @Test
  void should_reorder_first_two_replicas_when_first_has_more_in_flight_than_second() {
    // Given
    given(request.getRoutingKeyspace()).willReturn(KEYSPACE);
    given(request.getRoutingKey()).willReturn(ROUTING_KEY);
    given(tokenMap.getReplicas(KEYSPACE, ROUTING_KEY))
