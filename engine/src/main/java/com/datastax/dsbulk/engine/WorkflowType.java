...
public enum WorkflowType {
  LOAD {
    ...
    @Override
    public Workflow newWorkflow(Config config, BiMap<String, String> shortcuts) {
  ...
  public abstract Workflow newWorkflow(Config config, BiMap<String, String> shortcuts);
}
