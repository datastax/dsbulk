...
import static com.datastax.dsbulk.tests.utils.CsvUtils.INET_CONVERTER;
...
abstract class BulkExecutorSimulacronITBase {
  ...
  void primeQueries() {
    ...
    simulacron.prime(when("should fail").then(syntaxError("Bad Syntax")));
    simulacron.prime(when("SELECT * FROM ip_by_country").then(successResult));
  }
