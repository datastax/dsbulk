...
import com.datastax.loader.tests.ccm.factory.CCMClusterFactory;
import com.datastax.loader.tests.ccm.factory.ClusterFactory;
import com.datastax.loader.tests.ccm.factory.SessionFactory;
...
public class CCMRule implements TestRule {
  ...
  private static final String TEST_CLASS_NAME_KEY = "com.datastax.loader.tests.TEST_CLASS_NAME";
