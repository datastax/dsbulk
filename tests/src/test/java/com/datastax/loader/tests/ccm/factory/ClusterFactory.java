...
import com.datastax.loader.tests.ccm.annotations.ClusterConfig;
import com.datastax.loader.tests.ccm.annotations.ClusterFactoryMethod;
import com.datastax.loader.tests.utils.ReflectionUtils;
...
public abstract class ClusterFactory {
  ...
  @ClusterConfig
  private static Cluster dummy;

  static {
    ClusterConfig annotation = null;
    try {
      Field field = ClusterFactory.class.getDeclaredField("dummy");
      annotation = field.getAnnotation(ClusterConfig.class);
  ...
  public static ClusterFactory createInstanceForField(Field field, Class<?> testClass) {
    ClusterFactoryMethod factoryRef = field.getAnnotation(ClusterFactoryMethod.class);
    ClusterConfig config = field.getAnnotation(ClusterConfig.class);
    if (factoryRef != null) {
      if (config != null) {
