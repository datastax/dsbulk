...
class MapToMapCodecTest {
  private final ExtendedCodecRegistry codecRegistry = newCodecRegistry("");
  private final MapToMapCodec<Integer, Integer, Short, Short> codec =
      (MapToMapCodec<Integer, Integer, Short, Short>)
          codecRegistry.<Map<Integer, Integer>, Map<Short, Short>>convertingCodecFor(
              DataTypes.mapOf(DataTypes.SMALLINT, DataTypes.SMALLINT),
